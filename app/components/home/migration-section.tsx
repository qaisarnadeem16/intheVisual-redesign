...
const features = [
    'Complete Data Transfer – Products, orders, customers & content, safely moved.',
    'Custom Shopify Setup – We don’t just migrate — we optimize and redesign.',
    'No Downtime – Stay live while we handle everything behind the scenes.',
];
    ...
    return (
        <Section className="py-10 px-4 sm:px-6 lg:px-8">
            <h2 className="text-3xl text-center lg:text-6xl py-4 tracking-wider leading-normal font-bricola font-normal">
                Migrate to Shopify <br /> Effortlessly
            </h2>
