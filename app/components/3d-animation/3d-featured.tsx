import { threeDFeatures, wordpressFeatures } from '@/data/data';
...
const AnimationFeaturesSection = () => {
    return (
            ...
            <div className="grid lg:grid-cols-2 grid-cols-1 gap-5 items-center lg:py-10 py-5 lg:px-10">
                <div className=" mx-auto lg:w-4/5 w-full">
                    ...
                    <p className="text-base sm:text-lg text-gray-600 mb-3">
                        Transform Your Product Experience with 3D Animation Easy Integration on Any Platform
                    </p>

                    <ul className="text-left max-w-2xl mx-auto space-y-4 mb-10">
                        {threeDFeatures.map((item, idx) => (
...
export default AnimationFeaturesSection;